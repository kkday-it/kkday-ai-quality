...
> 📌 **性质：2026-07-15 定稿的離線實驗室執行規格，非系統現況說明。** §0 列的「代码只正式启用了
> C1/C2」等缺口描述皆為當時狀態，動手前請以 `scripts/prompt_lab/` 當前 code 覆核；線上初判引擎的
> 現況一律以根 `README.md`、`prompts/README.md` 與 code 為準。
