...
| [PRD-PROMPT-REVIEW-REVISE.md](./PRD-PROMPT-REVIEW-REVISE.md) | 售後根因 Prompt 調試台的人工評判 × AI 定點改寫閉環：補丁 anchor 驗證、回歸重跑設計與三批交付。⚠️ §2 資料模型已被演進取代（案例改存前端 localStorage，`prompt_debug_review_tbl` 已 drop），該節已加註 |
