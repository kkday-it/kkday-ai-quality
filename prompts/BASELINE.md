...
- **C-1-6 vs C-1-7 分界**（2026-08-10 使用者拍板）：頁面標示的**出單／確認時程承諾**（如「立即確認」）與事實不符 → **C-1-7 退改與服務承諾**；C-1-6 收的是「確認期限」這類**限制與風險**的揭露問題。（原記於 01_C-1_content.md 的例證括號內，2026-08-11 清出 prompt 本文後轉存於此）
