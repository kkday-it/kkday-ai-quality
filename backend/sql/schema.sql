...
CREATE TABLE IF NOT EXISTS prod_quality (
    ...
    overall_status    TEXT,
    positioning_n INTEGER DEFAULT 0, positioning_verdict TEXT,
    itinerary_n   INTEGER DEFAULT 0, itinerary_verdict   TEXT,
    fee_n         INTEGER DEFAULT 0, fee_verdict         TEXT,
    meetup_n      INTEGER DEFAULT 0, meetup_verdict      TEXT,
    redeem_n      INTEGER DEFAULT 0, redeem_verdict      TEXT,
    group_form_n  INTEGER DEFAULT 0, group_form_verdict  TEXT,
    restriction_n INTEGER DEFAULT 0, restriction_verdict TEXT,
    sla_n         INTEGER DEFAULT 0, sla_verdict         TEXT,
    last_judged_at    TEXT
);
