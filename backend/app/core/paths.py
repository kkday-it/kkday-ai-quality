...
AI_JUDGE_DIR: Path = (
    CONFIG_DIR / "ai_judge"
)  # 判決領域規則配置（judgment / source_mapping / domains；判準文字本體在 docs/prompts/prompts）
...
CALIBRATION_DIR: Path = DATA_DIR / "calibration"  # 信心校準參數（judge/calibration.py）
...
# repo 根 docs/：人閱文檔；其中 docs/prompts/prompts/ 為「判決 Prompt 唯一真相源」（7 支 md），
...
DOCS_PROMPTS_DIR: Path = DOCS_DIR / "prompts" / "prompts"
