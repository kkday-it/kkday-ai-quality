# AI 法官 · 欄位判決 Prompt — 費用資訊 / 現場需支付之強制費用（Mandatory Fees）
...
{
  "dimension": "費用資訊",
  "field": "現場需支付之強制費用（Mandatory Fees）",
  ...
  "reason": "對照 canon 的違規理由（典型違規原因：隱匿強制性費用）",
  "confidence": 0.0,
